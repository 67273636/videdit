...
from PyQt6.QtCore import (
    Qt, QTimer, QSize, QPoint, QThread, pyqtSignal, pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot pyqtSlot,
